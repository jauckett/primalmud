...
#define SPELL_FINGERDEATH            52 /* Reserved Skill[] DO NOT CHANGE */
#define SPELL_ADV_HEAL               53 /* Reserved Skill[] DO NOT CHANGE */
#define SPELL_REFRESH                54 /* Reserved Skill[] DO NOT CHANGE */
#define SPELL_FEAR                   55 /* Reserved Skill[] DO NOT CHANGE */
#define SPELL_GATE                   56 /* Reserved Skill[] DO NOT CHANGE */
#define SPELL_METEOR_SWARM	     57 /* Reserved Skill[] DO NOT CHANGE */
#define SPELL_GROUP_SANCTUARY        58 /* Reserved Skill[] DO NOT CHANGE */
#define SPELL_SERPENT_SKIN           59 /* Reserved Skill[] DO NOT CHANGE */
#define SPELL_FLY                    60
...
#define SPELL_WRAITH_TOUCH	     66 /* drain energy add to caster */
#define SPELL_DRAGON                 67 /* dragon spell added by Hal */
#define SPELL_MANA                   68 /* mana healing spell of a healer spec - Hal */
...
/* SPELL_CHANGED is what ppl have on them when they are a wolf/vamp */
/* this is a spell so we dont waste an AFF worsk just as well - Vader */
#define SPELL_CHANGED               130
...
#define SKILL_2ND_ATTACK            141 /* Reserved Skill[] DO NOT CHANGE */
#define SKILL_3RD_ATTACK            142 /* Reserved Skill[] DO NOT CHANGE */
#define SKILL_PRIMAL_SCREAM         143 /* Reserved Skill[] DO NOT CHANGE */
#define SKILL_SCAN                  144 /* Reserved Skill[] DO NOT CHANGE */
#define SKILL_HUNT                  145 /*    "       "      "  "    "    */
#define SKILL_RETREAT		    146 /*    "       "      "  "     "  */
#define SKILL_THROW		    147 /*    "       "      "  "     "  */
#define SKILL_COMPARE               148 /* change it n ill slap ya,..   */
#define SKILL_SPY		    149 /* DM - spy skill		*/ 
...
struct spell_info_type {
   ...
   ubyte mana_min;	/* Min amount of mana used by a spell (highest lev) */
   ubyte mana_max;	/* Max amount of mana used by a spell (lowest lev) */
   ubyte mana_change;	/* Change in mana used by spell from lev to lev */
...
void	spellname(ubyte level, struct char_data *ch, \
