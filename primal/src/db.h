...
#define AREA_FILE	"text/areas"	/* info on areas, zones		*/
...
#define CLAN_FILE       "misc/clans"    /* clan data                	*/
...
char clan_tables[CLAN_NUM][MAX_STRING_LENGTH];  
...
/* clan data array, DM - note 0 is none */
struct clan_data clan_info[CLAN_NUM]; 
