			  ...
			  int cmd, char *arg)
{
  ...
  if (GET_GOLD(ch) < STAMP_PRICE) {
    sprintf(buf, "$n tells you, 'A stamp costs &Y%d&n coins.'\r\n"
  ...
  sprintf(buf, "$n tells you, 'I'll take &Y%d&n coins for the stamp.'\r\n"
