...
$!
$   IF (F$SEARCH("SYS$DISK:[]CONF.H_VMS").EQS."")
$   THEN
$!
$!    The CONF.H_VMS File Dosen't Exist, So Tell The User.
$!
$     WRITE SYS$OUTPUT ""
$     WRITE SYS$OUTPUT "The file CONF.H_VMS dosen't exist.  This file is"
$     WRITE SYS$OUTPUT "necessary to compile CircleMUD and is distributed"
$     WRITE SYS$OUTPUT "with the source code."
$     WRITE SYS$OUTPUT ""
$     WRITE SYS$OUTPUT "Since the CONF.H_VMS file is distributed with the"
$     WRITE SYS$OUPTUT "source files I recomend that you unpack the files"
$     WRITE SYS$OUPTUT "again or get a new source distribution."
$     WRITE SYS$OUPTUT ""
$!
