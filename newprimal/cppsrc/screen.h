...
#define CCNRM(ch,lvl)  (clr((ch),(lvl))?"&n":KNUL)
#define CCRED(ch,lvl)  (clr((ch),(lvl))?"&r":KNUL)
#define CCGRN(ch,lvl)  (clr((ch),(lvl))?"&g":KNUL)
#define CCYEL(ch,lvl)  (clr((ch),(lvl))?"&y":KNUL)
#define CCBLU(ch,lvl)  (clr((ch),(lvl))?"&b":KNUL)
#define CCMAG(ch,lvl)  (clr((ch),(lvl))?"&m":KNUL)
#define CCCYN(ch,lvl)  (clr((ch),(lvl))?"&c":KNUL)
#define CCWHT(ch,lvl)  (clr((ch),(lvl))?"&w":KNUL)
...
#define CCBRED(ch,lvl) (clr((ch),(lvl))?"&R":KNUL)
#define CCBGRN(ch,lvl) (clr((ch),(lvl))?"&G":KNUL)
#define CCBYEL(ch,lvl) (clr((ch),(lvl))?"&Y":KNUL)
#define CCBBLU(ch,lvl) (clr((ch),(lvl))?"&B":KNUL)
#define CCBMAG(ch,lvl) (clr((ch),(lvl))?"&M":KNUL)
#define CCBCYN(ch,lvl) (clr((ch),(lvl))?"&C":KNUL)
#define CCBWHT(ch,lvl) (clr((ch),(lvl))?"&W":KNUL)
...
#define CCGOLD(ch,lev)  CCBYEL(ch,lev)
