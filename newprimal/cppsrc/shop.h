...
struct shop_data {
   ...
   zone_vnum vznum;             /* Virtual zone number of this shop     */
   zone_rnum rznum;             /* Real zone number of this shop        */
...
// If item price is > SHOP_MAX_BUY_PRICE, a random number is generated between
// SHOP_MAX_BUY_PRICE and MIN(SHOP_ABS_MAX_PRICE, item price)
#define SHOP_MAX_BUY_PRICE	200000
#define SHOP_ABS_MAX_PRICE	500000
